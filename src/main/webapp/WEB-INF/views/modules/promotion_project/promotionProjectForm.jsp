...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/promotion_project/promotionProject/">招商项目列表</a></li>
		<li class="active"><a href="${ctx}/promotion_project/promotionProject/form?id=${promotionProject.id}">招商项目<shiro:hasPermission name="promotion_project:promotionProject:edit">${not empty promotionProject.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="promotion_project:promotionProject:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="promotionProject" action="${ctx}/promotion_project/promotionProject/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="releaseTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${promotionProject.releaseTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="form-actions">
			<shiro:hasPermission name="promotion_project:promotionProject:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
