...
<head>
    ...
    <link href="${ctxStatic}/common/add.css" type="text/css" rel="stylesheet" />
				...
				if ($(menuId).length > 0){
					...
					$.get($(this).attr("data-href"), function(data){
						...
						$(menuId + " .accordion-heading a").click(function(){
							$(menuId + " .accordion-toggle i").removeClass('icon-chevron-downadd').addClass('icon-chevron-rightadd');
							if(!$($(this).attr('data-href')).hasClass('in')){
								$(this).children("i").removeClass('icon-chevron-rightadd').addClass('icon-chevron-downadd');
							}
						});
						// 二级内容
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand"><img src="${ctxStatic}/images/logo.png">接触网补偿装置监控平台</div>
				<div class="nab-box">
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2016-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> ${fns:getConfig('version')} 
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
