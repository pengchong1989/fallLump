...
<body>
	...
	<form:form id="searchForm" modelAttribute="alarmData" action="${ctx}/receivedata/receivedata/alarmList" method="post" class="breadcrumb form-search">
		...
		<li><label>段号ID：</label><form:input path="segmentId" htmlEscape="false" maxlength="50" class="input-medium"/></li>
		<li><label>ID：</label><form:input path="id" htmlEscape="false" maxlength="50" class="input-medium"/></li>
		<ul class="ul-form">
