	...
	<form:form id="searchForm" modelAttribute="paramDto" action="${ctx}/cms/stats/article" method="post" class="breadcrumb form-search">
	 ...
	 <div  style="clear:both;">
                <div style="margin-top:100px;float:left;margin-left:80px;border:1px solid #3954a9;">
                	<div class="title" style="border-bottom:1px solid rgb(76, 104, 191);line-height:40px;clear:both;height:40px;padding:0 20px;background:rgb(76, 104, 191);color:#fff;margin-bottom:20px;"><span style="float:left;">状态曲线(A值)</span><a style="float:right;color:#fff;cursor:pointer;"></a></div>
                <div class="eacharts-wrap" style="padding:0 20px;"><div id="main1" style="width: 700px;height:450px;"></div></div>
                    
                </div>
               <div style="margin-top:100px;float:left;margin-left:80px;border:1px solid #3954a9;">
                	<div class="title" style="border-bottom:1px solid rgb(76, 104, 191);line-height:40px;clear:both;height:40px;padding:0 20px;background:rgb(76, 104, 191);color:#fff;margin-bottom:20px;"><span style="float:left;">状态曲线(B值)</span><a style="float:right;color:#fff;cursor:pointer;"></a></div>
